const Map<String, String> en = {
  ...
  'chooseYourGoal':'Choose your goal to see which diet works best for you',
   ...
   'maintainingWight':'Maintaining weight and forming an ideal proportional body',
   'weightGain':'Weight gain',
   'slimYouNeedGainWeight':'Slim and You need to gain a healthy weight',
   'maintainingWeight':'Maintaining weight',
   'YouIdealWeightWantMaintain':'You have an ideal weight and want to maintain it',
   ...
   'numberExerciseDuringWeek':'The number of times you exercise during the week',
   ...
   'followingProgramRecommended':'Based on your data, the following program has been recommended',
