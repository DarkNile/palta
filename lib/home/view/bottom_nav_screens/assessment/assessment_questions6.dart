...
class _AssessmentQuestion6State extends State<AssessmentQuestion6> {
  ...
  void dispose() {
    super.dispose();
    _homeController.heightController.value.clear();
    _homeController.weightController.value.clear();
  }
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Padding(
                    padding:
                        const EdgeInsets.only(right: 17, left: 10, top: 23),
                    child: Row(
                      children: [
                        IconButton(
                          icon: const Icon(
                        ...
                        Container(
                          ...
                          child: const ClipRRect(
                            ...
                            child: LinearProgressIndicator(
                              value: 1,
                              valueColor:
                                  AlwaysStoppedAnimation<Color>(avocado),
